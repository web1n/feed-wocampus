...
username = section:taboption("general", Value, "username", translate("Wo Campus username"))

password = section:taboption("general", Value, "password", translate("Wo Campus password"))
