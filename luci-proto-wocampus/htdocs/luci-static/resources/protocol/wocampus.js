...
return network.registerProtocol('wocampus', {
	getI18n: function() {
		return _('Hebei Unicom Wo Campus Client');
	},

	renderFormOptions: function(s) {
		var dev = this.getL2Device() || this.getDevice(), o;

		s.taboption('general', form.Value, 'username', _('Wo Campus username'));

		o = s.taboption('general', form.Value, 'password', _('Wo Campus password'));
		o.password = true;
